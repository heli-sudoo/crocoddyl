...
BOOST_PYTHON_MEMBER_FUNCTION_OVERLOADS(SolverFDDP2_solves, SolverFDDP2::solve, 0, 5)
BOOST_PYTHON_MEMBER_FUNCTION_OVERLOADS(SolverFDDP2_computeDirections, SolverDDP::computeDirection, 0, 1)

void exposeSolverFDDP2() {
  bp::register_ptr_to_python<boost::shared_ptr<SolverFDDP2> >();

  bp::class_<SolverFDDP2, bp::bases<SolverDDP> >(
      "SolverFDDP2",
      ...
      .def("updateExpectedImprovement", &SolverFDDP2::updateExpectedImprovement,
           bp::return_value_policy<bp::copy_const_reference>(), bp::args("self"),
           "Update the expected improvement model\n\n")
      .add_property("th_acceptNegStep", bp::make_function(&SolverFDDP2::get_th_acceptnegstep),
                    bp::make_function(&SolverFDDP2::set_th_acceptnegstep),
